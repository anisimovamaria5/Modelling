...
Revision ID: 2c39fcfad6d8
Revises: 
Create Date: 2025-11-26 17:09:28.986092
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('dimen', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('dimen_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['dimen_id'], ['DIMENSION.id'], ),
    sa.PrimaryKeyConstraint('id'),
    comment='Таблица кодов размерностей и единицами измерения'
    )
    op.create_table('DKS',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    ...
    sa.Column('diam', sa.Float(), nullable=True, comment='Диаметр'),
